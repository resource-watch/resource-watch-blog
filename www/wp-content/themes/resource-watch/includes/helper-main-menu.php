...
?>
		<?php get_template_part( 'includes/helper-search' ); ?>
				 ...
				 $output .= "<div class='container av-logo-container'>";
					...
					$output .= "<div class='inner-container'>";
						...
						*/
							...
							$main_nav_class = $user_info ? 'main_menu logged-in' : 'main_menu logged-out';
							if ($user_info["role"] === 'ADMIN') {
								$main_nav_class .= ' is-admin'; 
							}
						
						    $main_nav = "<nav class='".$main_nav_class."' data-selectname='".__('Select a page','avia_framework')."' ".avia_markup_helper(array('context' => 'nav', 'echo' => false)).">";
						    ...
						    */
							...
							$main_nav .= '<div class="user-img" style="background-image: url('.$user_info["Photo"].')"></div></nav>';
