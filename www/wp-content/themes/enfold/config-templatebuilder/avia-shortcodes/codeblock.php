...
if ( !class_exists( 'avia_sc_codeblock' ) )
{
    class avia_sc_codeblock extends aviaShortcodeTemplate
    {
        ...
        public function shortcode_insert_button()
        {
            ...
            $this->config['tooltip']        = __('Add text, shortcodes or code to your website without any formatting or text optimization. Can be used for HTML/CSS/Javascript', 'avia_framework' );
